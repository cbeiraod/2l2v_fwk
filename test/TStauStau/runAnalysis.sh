...
runLocalAnalysisOverSamples.py -e runTStauStauAnalysisFWLite -j tstaustau_samples_full.json -d  /lustre/ncg.ingrid.pt/cmst3/store/user/cbeiraod/14_08_06_2l2nu_EDMtuples_merged/ -o /lustre/ncg.ingrid.pt/cmslocal/cbeiraod/WithSyst_Prompt/ -c runAnalysis_cfg.py.templ -p "@saveSummaryTree=True @runSystematics=True @exclusiveRun=True @applyScaleFactors=True @doSVfit=False" -s 8nh
